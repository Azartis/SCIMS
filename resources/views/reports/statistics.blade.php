                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="text-center">
                            <div class="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">{{ $genderStats['male'] }}</div>
                            <p class="text-gray-600 dark:text-gray-400">Male</p>
                            <div class="mt-3 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $genderStats['male'] > 0 ? min(($genderStats['male'] / max($genderStats['male'], $genderStats['female'], $genderStats['other']) * 100), 100) : 0 }}%"></div>
                            </div>
                        </div>

                        <div class="text-center">
                            <div class="text-4xl font-bold text-pink-600 dark:text-pink-400 mb-2">{{ $genderStats['female'] }}</div>
                            <p class="text-gray-600 dark:text-gray-400">Female</p>
                            <div class="mt-3 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-pink-600 h-2 rounded-full" style="width: {{ $genderStats['female'] > 0 ? min(($genderStats['female'] / max($genderStats['male'], $genderStats['female'], $genderStats['other']) * 100), 100) : 0 }}%"></div>
                            </div>
                        </div>

                        <div class="text-center">
                            <div class="text-4xl font-bold text-gray-600 dark:text-gray-400 mb-2">{{ $genderStats['other'] }}</div>
                            <p class="text-gray-600 dark:text-gray-400">Other</p>
                            <div class="mt-3 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-gray-600 h-2 rounded-full" style="width: {{ $genderStats['other'] > 0 ? min(($genderStats['other'] / max($genderStats['male'], $genderStats['female'], $genderStats['other']) * 100), 100) : 0 }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
