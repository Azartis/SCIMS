<x-app-layout>
    ...
    <div class="py-3 px-4 sm:px-0">
        <div class="max-w-6xl mx-auto">
            <form action="{{ route('senior-citizens.update', $seniorCitizen) }}" method="POST" id="oscaForm" onsubmit="prepareFormSubmit(event)">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-3 border-t-4 border-blue-600">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        <div class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600">
                            ...
                            <x-text-input id="osca_id" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="text" name="osca_id" :value="old('osca_id', $seniorCitizen->osca_id)" required />
                        ...
                        <div class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600">
                            ...
                            <x-text-input id="national_id" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="text" name="national_id" placeholder="0000-0000-0000-0000" :value="old('national_id', $seniorCitizen->national_id)" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        <div class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600">
                            ...
                            <x-text-input id="lastname" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="text" name="lastname" :value="old('lastname', $seniorCitizen->lastname)" required />
                        ...
                        <div class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600">
                            ...
                            <x-text-input id="firstname" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="text" name="firstname" :value="old('firstname', $seniorCitizen->firstname)" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        <div class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600">
                            ...
                            <x-text-input id="middlename" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="text" name="middlename" :value="old('middlename', $seniorCitizen->middlename)" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        <div class="p-2 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-200 dark:border-blue-700">
                            ...
                            <x-text-input id="date_of_birth" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="date" name="date_of_birth" :value="old('date_of_birth', $seniorCitizen->date_of_birth)" required onchange="computeAge()" />
                        ...
                        <div class="p-2 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-200 dark:border-blue-700">
                            ...
                            <select id="barangay" name="barangay" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" required>
                                ...
                                @foreach(\App\Constants\Barangay::list() as $b)
                                    <option value="{{ $b }}" @selected(old('barangay', $seniorCitizen->barangay)===$b)>{{ $b }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="p-2 bg-amber-50 dark:bg-amber-900/20 rounded border border-amber-200 dark:border-amber-700 mb-2">
                        ...
                        <textarea id="address" name="address" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" rows="2" placeholder="Enter municipal address" required>{{ old('address', $seniorCitizen->address) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        <div class="p-2 bg-green-50 dark:bg-green-900/20 rounded border border-green-200 dark:border-green-700">
                            ...
                            <x-text-input id="contact_number" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="tel" name="contact_number" placeholder="e.g., 09XX-XXX-XXXX" :value="old('contact_number', $seniorCitizen->contact_number)" />
                        </div>
                        <div class="p-2 bg-green-50 dark:bg-green-900/20 rounded border border-green-200 dark:border-green-700">
                            <x-input-label for="religion" :value="__('Email Address')" class="text-xs font-semibold text-gray-800 dark:text-gray-100" />
                            <x-text-input id="religion" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="email" name="religion" placeholder="Enter email (optional)" :value="old('religion', $seniorCitizen->religion)" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-3 border-t-4 border-green-600">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        ...
                        <div class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600">
                            ...
                            <div class="space-y-0.5">
                                <label class="flex items-center cursor-pointer text-xs">
                                    <input type="radio" name="bedridden" value="1" class="form-radio w-3 h-3" @checked(old('bedridden', $seniorCitizen->bedridden)==='1' || old('bedridden', $seniorCitizen->bedridden)===1)>
                                    <span class="ms-2">Yes, Bedridden</span>
                                </label>
                                <label class="flex items-center cursor-pointer text-xs">
                                    <input type="radio" name="bedridden" value="0" class="form-radio w-3 h-3" @checked(old('bedridden', $seniorCitizen->bedridden)==='0' || old('bedridden', $seniorCitizen->bedridden)===0 || old('bedridden', $seniorCitizen->bedridden)===null)>
                        ...
                        <div class="p-2 bg-amber-50 dark:bg-amber-900/20 rounded border border-amber-200 dark:border-amber-700">
                            ...
                            <div class="space-y-0.5">
                                <label class="flex items-center cursor-pointer text-xs">
                                    <input type="radio" name="with_assistive_device" value="1" class="form-radio w-3 h-3 assistive-device-radio" @checked(old('with_assistive_device', $seniorCitizen->with_assistive_device)==='1' || old('with_assistive_device', $seniorCitizen->with_assistive_device)===1)>
                                    <span class="ms-2">Yes</span>
                                </label>
                                <label class="flex items-center cursor-pointer text-xs">
                                    <input type="radio" name="with_assistive_device" value="0" class="form-radio w-3 h-3 assistive-device-radio" @checked(old('with_assistive_device', $seniorCitizen->with_assistive_device)==='0' || old('with_assistive_device', $seniorCitizen->with_assistive_device)===0 || old('with_assistive_device', $seniorCitizen->with_assistive_device)===null)>
                    ...
                    <div class="mb-2 p-2 bg-amber-100 dark:bg-amber-900/30 rounded border border-amber-300 dark:border-amber-700" id="specify_device_container" style="display: none;">
                        ...
                        <x-text-input id="type_of_assistive_device" class="block mt-1 w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" type="text" name="type_of_assistive_device" placeholder="e.g., Wheelchair, Crutches, Walker" :value="old('type_of_assistive_device', $seniorCitizen->type_of_assistive_device)" />
                    </div>
                    ...
                    <div class="mb-2 p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600">
                        ...
                        <div>
                            <label class="flex items-center cursor-pointer p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input type="checkbox" name="with_disability" value="1" class="form-checkbox rounded" @checked(old('with_disability', $seniorCitizen->with_disability))>
                    ...
                    <!-- Type of Disability -->
                    <div class="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700" id="cause_disability_container" style="display: none;">
                        ...
                        <select id="type_of_disability" name="type_of_disability" class="block w-full text-xs border-gray-300 dark:border-gray-600 rounded-md">
                            ...
                            <option value="Deaf" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Deaf')>Deaf or Hard of Hearing</option>
                            <option value="Intellectual Disability" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Intellectual Disability')>Intellectual Disability</option>
                            <option value="Learning Disability" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Learning Disability')>Learning Disability</option>
                            <option value="Mental Disability" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Mental Disability')>Mental Disability</option>
                            <option value="Physical disability" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Physical disability')>Physical disability</option>
                            <option value="Psychosocial Disability" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Psychosocial Disability')>Psychosocial Disability</option>
                            <option value="Speech and language impairment" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Speech and language impairment')>Speech and language impairment</option>
                            <option value="Visual Disability" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Visual Disability')>Visual Disability</option>
                            <option value="Cancer" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Cancer')>Cancer</option>
                            <option value="Rare Disease" @selected(old('type_of_disability', $seniorCitizen->type_of_disability)==='Rare Disease')>Rare Disease</option>
                        </select>
                        ...
                        <div class="space-y-0.5">
                            <label class="flex items-center cursor-pointer text-xs">
                                <input type="radio" name="cause_of_disability" value="Congenital/Inborn" class="form-radio w-3 h-3" @checked(old('cause_of_disability', $seniorCitizen->cause_of_disability)==='Congenital/Inborn')>
                                <span class="ms-2">Congenital/Inborn</span>
                            </label>
                            <label class="flex items-center cursor-pointer text-xs">
                                <input type="radio" name="cause_of_disability" value="Acquired" class="form-radio w-3 h-3" @checked(old('cause_of_disability', $seniorCitizen->cause_of_disability)==='Acquired')>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        <div class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600">
                            ...
                            <div class="space-y-0.5">
                                <label class="flex items-center cursor-pointer text-xs">
                                    <input type="radio" id="pensioner_yes" name="is_pensioner" value="1" class="form-radio w-3 h-3 pensioner-radio" @checked(old('is_pensioner', $seniorCitizen->is_pensioner)==='1' || old('is_pensioner', $seniorCitizen->is_pensioner)===1)>
                                    <span class="ms-2">Yes</span>
                                </label>
                                <label class="flex items-center cursor-pointer text-xs">
                                    <input type="radio" id="pensioner_no" name="is_pensioner" value="0" class="form-radio w-3 h-3 pensioner-radio" @checked(old('is_pensioner', $seniorCitizen->is_pensioner)==='0' || old('is_pensioner', $seniorCitizen->is_pensioner)===0 || old('is_pensioner', $seniorCitizen->is_pensioner)===null)>
                                    <span class="ms-2">No</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="p-2 bg-purple-50 dark:bg-purple-900/20 rounded border-l-4 border-purple-500" id="pension_type_container" style="display: none;">
                            ...
                            <select id="pension_type" name="pension_type" class="block w-full text-xs border-gray-300 dark:border-gray-600 rounded-md">
                                ...
                                <option value="GSIS" @selected(old('pension_type', $seniorCitizen->pension_type)==='GSIS')>GSIS (Government Service Insurance System)</option>
                                <option value="PVAO" @selected(old('pension_type', $seniorCitizen->pension_type)==='PVAO')>PVAO (Philippine Veterans Affairs Office)</option>
                                <option value="Others" @selected(old('pension_type', $seniorCitizen->pension_type)==='Others')>Other</option>
                            </select>
                        </div>
                    </div>
