<x-app-layout>
            ...
            <form action="{{ route('senior-citizens.store') }}" method="POST" id="oscaForm" onsubmit="prepareFormSubmit(event)">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-3 border-t-4 border-green-600">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        ...
                        <div id="source_income_container" class="p-2 bg-gray-50 dark:bg-gray-700/50 rounded border border-gray-200 dark:border-gray-600" style="display: {{ old('is_pensioner') === '1' ? 'none' : 'block' }};">
                            ...
                            <select id="source_of_income" name="source_of_income" class="block w-full text-xs border-gray-300 dark:border-gray-600 rounded-md" {{ old('is_pensioner') === '1' ? 'disabled' : '' }}>
                                <option value="">-- Select Source --</option>
                                <option value="Employment/Salary" @selected(old('source_of_income')==='Employment/Salary')>Wages / Salaries</option>
                                ...
                                <option value="Business" @selected(old('source_of_income')==='Business')>Profits from entrepreneurial activities</option>
                                <option value="Remittance" @selected(old('source_of_income')==='Remittance')>Remittance (Friends & Neighbours)</option>
                                <option value="Government Assistance" @selected(old('source_of_income')==='Government Assistance')>Transfers from the government</option>
                                <option value="Household family members/relatives" @selected(old('source_of_income')==='Household family members/relatives')>Household family members/relatives</option>
                                <option value="Domestic household family members/relatives" @selected(old('source_of_income')==='Domestic household family members/relatives')>Domestic household family members/relatives</option>
                                <option value="International family members/relatives" @selected(old('source_of_income')==='International family members/relatives')>International family members/relatives</option>
                    ...
                    <div class="mb-2 p-2 bg-indigo-100 dark:bg-indigo-900/30 rounded border border-indigo-300 dark:border-indigo-700" id="specify_income_container" style="display: {{ (old('is_pensioner') === '1') || (old('source_of_income') !== 'Others') ? 'none' : 'block' }};">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Show/hide pension type and source of income based on pensioner selection
            const pensionerYes = document.getElementById('pensioner_yes').checked;
